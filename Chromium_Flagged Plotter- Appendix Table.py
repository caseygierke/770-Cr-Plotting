...
input = 'Alluvial Wells- 2020-04-21'
inputFolder = 'Inputs'

# Make dictionary for appendix figures
figureDict = {}
Dictin = open(path+os.sep+'Python'+os.sep+'Plotting'+os.sep+inputFolder+os.sep+input+'.ascii','r')
...
locID_index = headers.index('Well ID')
...
for line in Dictin:
	Columns = line.split('\t')
	figureDict[Columns[0]] = {'Lat': Columns[lat_index], 'Long': Columns[long_index], 'Aquifer': 'Alluvial'}
...
for location in figureDict:
	...
	# Save the figure
	fig.savefig(path+os.sep+'Python'+os.sep+'Plotting'+os.sep+'Outputs'+os.sep+'Figures'+os.sep+input+os.sep+figureDict[location]['Aquifer']+'- '+location+'.png',dpi=500)
