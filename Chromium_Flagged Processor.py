...
# Define input file
input = 'Narrowed- Intellus Chromium Data'
# input = 'Narrowed- Intellus Monitoring Wells'
# input = 'Narrowed- Well Info'
# input = 'Narrowed- Well Info- Final'

# Make dictionary for appendix figures
figureDict = {}
Dictin = open(path+os.sep+'Python'+os.sep+'Plotting'+os.sep+input+'.txt','r')
