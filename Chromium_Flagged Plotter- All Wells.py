# Chromium_Flagged Plotter- All Wells.py
...
figureDict = {}
Dictin = open(path+os.sep+'Python'+os.sep+'Plotting'+os.sep+'Locations- All.txt','r')
...
# # Short circuit
# figureDict = {'R-35b': figureDict['R-35b']}

# Create an outfile for storing maxes
fout = open(path+os.sep+'Python'+os.sep+'Plotting'+os.sep+'Maxes- All Wells.txt','w')

# Create an outfile for storing maxes
foutExceedance = open(path+os.sep+'Python'+os.sep+'Plotting'+os.sep+'Exceedance- All Wells.txt','w')

# Create an outfile for defining active locations
foutActive = open(path+os.sep+'Python'+os.sep+'Plotting'+os.sep+'Active Locations.txt','w')
...
for location in figureDict:
	...
	if not os.path.exists(path+os.sep+'Intellus Data'+os.sep+'Figures'+os.sep+'All Wells'+os.sep):
		os.makedirs(path+os.sep+'Intellus Data'+os.sep+'Figures'+os.sep+'All Wells'+os.sep)

	# fig.savefig(path+os.sep+'Figures'+os.sep+inpst+'.png',dpi=500)
	fig.savefig(path+os.sep+'Intellus Data'+os.sep+'Figures'+os.sep+'All Wells'+os.sep+location+'.png',dpi=500)
	# if inpst in figureDict:
		# fig.savefig(path+os.sep+'Figures'+os.sep+'Appendix Figures'+os.sep+figureDict[inpst]+'.png',dpi=500)
