# Chromium_Flagged Plotter- Intellus Monitoring Wells.py
...
figureDict = {}
Dictin = open(path+os.sep+'Python'+os.sep+'Plotting'+os.sep+'Locations- '+input+'.txt','r')
...
locID_index = headers.index('locationID')
