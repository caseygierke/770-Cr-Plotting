# Chromium_Flagged Plotter- Well Info.py
...
figureDict = {}
Dictin = open(path+os.sep+'Python'+os.sep+'Plotting'+os.sep+'Locations- Well Info.txt','r')
...
for line in Dictin:
	Columns = line.split('\t')
	# figureDict[Columns[0]] = {'Figure Letter': Columns[1], 'Aquifer': Columns[2][:-1]}
...
fout = open(path+os.sep+'Python'+os.sep+'Plotting'+os.sep+'Maxes- Well Info.txt','w')

# Create an outfile for storing maxes
foutExceedance = open(path+os.sep+'Python'+os.sep+'Plotting'+os.sep+'Exceedance- Well Info.txt','w')

# Create an outfile for defining active locations
foutActive = open(path+os.sep+'Python'+os.sep+'Plotting'+os.sep+'Active- Well Info.txt','w')
...
for location in figureDict:
	...
	if not os.path.exists(path+os.sep+'Intellus Data'+os.sep+'Figures'+os.sep+'Well Info'+os.sep):
		os.makedirs(path+os.sep+'Intellus Data'+os.sep+'Figures'+os.sep+'Well Info'+os.sep)

	# fig.savefig(path+os.sep+'Figures'+os.sep+inpst+'.png',dpi=500)
	fig.savefig(path+os.sep+'Intellus Data'+os.sep+'Figures'+os.sep+'Well Info'+os.sep+figureDict[location]['Aquifer']+'- '+location+'.png',dpi=500)
	# if inpst in figureDict:
		# fig.savefig(path+os.sep+'Figures'+os.sep+'Appendix Figures'+os.sep+figureDict[inpst]+'.png',dpi=500)
