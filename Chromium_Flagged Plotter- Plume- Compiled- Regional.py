# Chromium_Flagged Plotter- Plume- Compiled- Regional.py
...
figureDict = {}
Dictin = open(path+os.sep+'Python'+os.sep+inputFolder+os.sep+input+'.txt','r')
...
for location in figureDict:
	...
	fout.write(location+'\t'+str(maxDate)+'\t'+str(maxResult)+'\t'+str(lastDate)+'\t'+str(lastResult)+'\t'+maxND+'\t'+maxF+'\t'+str(len(result))+'\n')
